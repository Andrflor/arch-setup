    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        coc_nvim_1.workspace.onDidChangeWorkspaceFolders(e => {
            if (e.added) {
                ...
                if (folder)
                    coc_nvim_1.workspace.showMessage(`Multiple rust workspace folder not supported!`, 'warning');
            }
        });
    ...
    makeRlsEnv(setLibPath = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                coc_nvim_1.workspace.showMessage(err.message);
                coc_nvim_1.workspace.showMessage(`Let's retry with extended $PATH`);
                ...
                try {
                    ...
                    coc_nvim_1.workspace.showMessage(`Error reading sysroot: ${e.message}`, 'warning');
                    return env;
                }
            }
            coc_nvim_1.workspace.showMessage(`Setting sysroot to` + sysroot);
            if (setLibPath) {
    ...
    makeRlsProcess() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rls_path) {
                ...
                coc_nvim_1.workspace.showMessage(`running: ${rls_path} at ${coc_nvim_1.workspace.rootPath}`);
                childProcess = child_process.spawn(rls_path, [], { env, cwd: coc_nvim_1.workspace.rootPath });
            }
            else if (this.config.rustupDisabled) {
                const env = yield this.makeRlsEnv(true);
                coc_nvim_1.workspace.showMessage(`running: rls at ${coc_nvim_1.workspace.rootPath}`);
                ...
                coc_nvim_1.workspace.showMessage(`running: ${config.path} run ${config.channel} rls, at ${coc_nvim_1.workspace.rootPath}`);
